            ...
            else
            {
                ...
                if (int.Parse(deffendingArmies.Text) == 0)
                {
                    ...
                    if (checkTerritoryAmount(colorid) == 0)
                    {
                        ...
                        if (color1 == colorid) { playerOrderNumber = 1; }
                        if (color2 == colorid) { playerOrderNumber = 2; }
                        if (color3 == colorid) { playerOrderNumber = 3; }
                        if (color4 == colorid) { playerOrderNumber = 4; }
                        if (color5 == colorid) { playerOrderNumber = 5; }
                        if (color6 == colorid) { playerOrderNumber = 6; }
