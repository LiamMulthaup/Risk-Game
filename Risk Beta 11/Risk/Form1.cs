...
namespace Risk
{
    public partial class RiskBoard : Form
    {
        ...
        private void recordPresentArmyData()
        {
            ...
            outputFile = File.CreateText("ArmyData.txt");
            outputFile.WriteLine(argentina.Text);
            outputFile.WriteLine(venezuela.Text);
            outputFile.WriteLine(brazil.Text);
            outputFile.WriteLine(peru.Text);
            outputFile.WriteLine(centralAmerica.Text);
            outputFile.WriteLine(easternUnitedStates.Text);
            outputFile.WriteLine(quebec.Text);
            outputFile.WriteLine(westernUnitedStates.Text);
            outputFile.WriteLine(ontario.Text);
            outputFile.WriteLine(alberta.Text);
            outputFile.WriteLine(alaska.Text);
            outputFile.WriteLine(northWestTerritory.Text);
            outputFile.WriteLine(greenLand.Text);
            outputFile.WriteLine(northAfrica.Text);
            outputFile.WriteLine(egypt.Text);
            outputFile.WriteLine(eastAfrica.Text);
            outputFile.WriteLine(congo.Text);
            outputFile.WriteLine(southAfrica.Text);
            outputFile.WriteLine(madagascar.Text);
            outputFile.WriteLine(westernEurope.Text);
            outputFile.WriteLine(southernEurope.Text);
            outputFile.WriteLine(northernEurope.Text);
            outputFile.WriteLine(greatBritain.Text);
            outputFile.WriteLine(ukraine.Text);
            outputFile.WriteLine(scandinavia.Text);
            outputFile.WriteLine(iceland.Text);
            outputFile.WriteLine(middleEast.Text);
            outputFile.WriteLine(afghanistan.Text);
            outputFile.WriteLine(india.Text);
            outputFile.WriteLine(siam.Text);
            outputFile.WriteLine(china.Text);
            outputFile.WriteLine(ural.Text);
            outputFile.WriteLine(mongolia.Text);
            outputFile.WriteLine(siberia.Text);
            outputFile.WriteLine(yakutsk.Text);
            outputFile.WriteLine(irkutsk.Text);
            outputFile.WriteLine(japan.Text);
            outputFile.WriteLine(kamchatka.Text);
            outputFile.WriteLine(indonesia.Text);
            outputFile.WriteLine(newGuinea.Text);
            outputFile.WriteLine(westernAustralia.Text);
            outputFile.WriteLine(easternAustralia.Text);
            outputFile.Close();
        }
        private void resetText()
        {
            ...
            string transfer;
            inputFile = File.OpenText("ArmyData.txt");
            transfer = inputFile.ReadLine();
            argentina.Text = transfer; transfer = inputFile.ReadLine();
            venezuela.Text = transfer; transfer = inputFile.ReadLine();
            brazil.Text = transfer; transfer = inputFile.ReadLine();
            peru.Text = transfer; transfer = inputFile.ReadLine();
            centralAmerica.Text = transfer; transfer = inputFile.ReadLine();
            easternUnitedStates.Text = transfer; transfer = inputFile.ReadLine();
            quebec.Text = transfer; transfer = inputFile.ReadLine();
            westernUnitedStates.Text = transfer; transfer = inputFile.ReadLine();
            ontario.Text = transfer; transfer = inputFile.ReadLine();
            alberta.Text = transfer; transfer = inputFile.ReadLine();
            alaska.Text = transfer; transfer = inputFile.ReadLine();
            northWestTerritory.Text = transfer; transfer = inputFile.ReadLine();
            greenLand.Text = transfer; transfer = inputFile.ReadLine();
            northAfrica.Text = transfer; transfer = inputFile.ReadLine();
            egypt.Text = transfer; transfer = inputFile.ReadLine();
            eastAfrica.Text = transfer; transfer = inputFile.ReadLine();
            congo.Text = transfer; transfer = inputFile.ReadLine();
            southAfrica.Text = transfer; transfer = inputFile.ReadLine();
            madagascar.Text = transfer; transfer = inputFile.ReadLine();
            westernEurope.Text = transfer; transfer = inputFile.ReadLine();
            southernEurope.Text = transfer; transfer = inputFile.ReadLine();
            northernEurope.Text = transfer; transfer = inputFile.ReadLine();
            greatBritain.Text = transfer; transfer = inputFile.ReadLine();
            ukraine.Text = transfer; transfer = inputFile.ReadLine();
            scandinavia.Text = transfer; transfer = inputFile.ReadLine();
            iceland.Text = transfer; transfer = inputFile.ReadLine();
            middleEast.Text = transfer; transfer = inputFile.ReadLine();
            afghanistan.Text = transfer; transfer = inputFile.ReadLine();
            india.Text = transfer; transfer = inputFile.ReadLine();
            siam.Text = transfer; transfer = inputFile.ReadLine();
            china.Text = transfer; transfer = inputFile.ReadLine();
            ural.Text = transfer; transfer = inputFile.ReadLine();
            mongolia.Text = transfer; transfer = inputFile.ReadLine();
            siberia.Text = transfer; transfer = inputFile.ReadLine();
            yakutsk.Text = transfer; transfer = inputFile.ReadLine();
            irkutsk.Text = transfer; transfer = inputFile.ReadLine();
            japan.Text = transfer; transfer = inputFile.ReadLine();
            kamchatka.Text = transfer; transfer = inputFile.ReadLine();
            indonesia.Text = transfer; transfer = inputFile.ReadLine();
            newGuinea.Text = transfer; transfer = inputFile.ReadLine();
            westernAustralia.Text = transfer; transfer = inputFile.ReadLine();
            easternAustralia.Text = transfer; transfer = inputFile.ReadLine();
            inputFile.Close();
        }
    }
}
