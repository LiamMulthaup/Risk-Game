...
namespace Risk
{
    public partial class RiskBoard : Form
    {
        ...
        private void removePlayer(int playerOrderNumber)
        {
            ...
            if (orderplayer1 == playerOrderNumber) { orderplayer1 = -1;}
            if (orderplayer2 == playerOrderNumber) { orderplayer2 = -1;}
            if (orderplayer3 == playerOrderNumber) { orderplayer3 = -1;}
            if (orderplayer4 == playerOrderNumber) { orderplayer4 = -1;}
            if (orderplayer5 == playerOrderNumber) { orderplayer5 = -1;}
            if (orderplayer6 == playerOrderNumber) { orderplayer6 = -1;}
        ...
        private void runGame()// This is a sort of hub for the actual running of the game, methods return here if they are transitioning a phase.
        {
            ...
            if (turnPhase == 11)
            {
                ...
                armiesTrackBar.Visible = true;
                Label lbl = attackingTerritory as Label;
                armiesTrackBar.Maximum = int.Parse(lbl.Text);
                armiesTrackBar.Value = armiesTrackBar.Maximum;
